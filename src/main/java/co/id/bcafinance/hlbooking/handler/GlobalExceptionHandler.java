...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(XSSAttackExcception.class)
    public ResponseEntity<Object> XSSAttackExcception(XSSAttackExcception ex, WebRequest request) {
        strExceptionArr[1] = "XSSAttackExcception(XSSAttackExcception ex, WebRequest request) \n"+RequestCapture.allRequest(request);
        LoggingFile.exceptionStringz(strExceptionArr, ex, OtherConfig.getFlagLoging());
        return buildResponseEntity(new ApiError(HttpStatus.FORBIDDEN,"Anda terdeteksi berniat Jahat - X99030!!",ex,request.getDescription(false),"X-99-030"));
    }
    @ExceptionHandler(XSSParamException.class)
    public ResponseEntity<Object> XSSParamException(XSSParamException ex, WebRequest request) {
        return buildResponseEntity(new ApiError(HttpStatus.FORBIDDEN,"Anda terdeteksi berniat Jahat Memassukan Script lewat Parameter - X99031!!",ex,request.getDescription(false),"X-99-031"));
    }
